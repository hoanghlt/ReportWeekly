...
### 1.1. Đang thực hiện
- **Xử lý phần tình trạng, kết quả tư vấn theo SOP** _(chưa bắt đầu)_
- **Migration Website client** 
- **Migration api backend** 
- **Thay đổi thông tin địa chỉ khách hàng, bỏ quận/huyện** _(chưa bắt đầu)_
- **Test round 2 QC SOP WSALE DKOL OMNISELL**
...
- **Tích hợp Wifi 7** _(chưa bắt đầu)_